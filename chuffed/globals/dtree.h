...
public:
    DTreePropagator(int _r, vec<BoolView>& _vs, vec<BoolView>& _es, 
...
public:
    DTreeParenthoodPropagator(int _r, vec<BoolView>& _vs, vec<BoolView>& _es, 
                              vec<IntVar*>& parents,
                              vec< vec<edge_id> >& _in, vec< vec<edge_id> >& _out,
                              vec< vec<int> >& _en);
...
public:
    PathDeg1(vec<BoolView>& _vs, vec<BoolView>& _es, 
             vec< vec<edge_id> >& _in, vec< vec<edge_id> >& _out,
             vec< vec<int> >& _en);
