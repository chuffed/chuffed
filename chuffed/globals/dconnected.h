...
public:
    FilteredLT(GraphPropagator* _p, int _r,
...
public:
    ...
    DReachabilityPropagator(int _r, vec<BoolView>& _vs, vec<BoolView>& _es, 
    ...
    void reverseDFStoBorder(int u, std::vector<bool>& v, 
                            std::vector<bool>& my_side,
                            vec<Lit>& expl, int skip_n = -1);
