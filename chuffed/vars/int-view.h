...
public:
	...
	int getEvent(int e) const { return (type & 1) ? (e & 9) + ((e & 2) << 1) + ((e & 4) >> 1) : e; }
	...
	Lit getMinLit() const { return (type & 1) ? var->getMaxLit() : var->getMinLit(); }
	Lit getMaxLit() const { return (type & 1) ? var->getMinLit() : var->getMaxLit(); }
